...
<li class="newsContent-item">
    <div class="newsContent-itemBox">
        <!--種別-->
        <div class="newsTag tag_red">コラボガチャ！</div>
        <!--掲載日-->
        <div class="newsDate">2023.11.03</div>
    </div>
    <!--遷移先URL-->
    <a href="../page/page_231105_ban_gacha.php">
    <!--バナー表示-->
    <img src="<?php include '../../php/domain.php'; ?>/news/2023_1105_release/ban/231100_ban_collab.png" width="100%" alt="">
    <!--テキスト表示
    ※ガチャ画面に移動します<br>-->
    </a>
    <!--メモ：URL遷移(Web遷移の場合)-->
