...
/*表示終了日時*/
$closeTime = new DateTime('2033-10-25 23:59:59');
if ($now >= $startTime && $now < $closeTime): ?>
<li class="newsContent-item">
    <div class="newsContent-itemBox">
        <!--種別-->
        <div class="newsTag tag_red">物語</div>
        <!--掲載日-->
        <div class="newsDate">2023.11.01</div>
    </div>
    <!--遷移先URL-->
    <a href="../news/page/page_230713_story.php">
    <!--バナー表示-->
    <img src="<?php include '../../php/domain.php'; ?>/news/2023_0715_release/ban/230713_ban_story.png" width="100%" alt="">
    <!--テキスト表示
    ※ガチャ画面に移動します<br>-->
    </a>
    <!--メモ：URL遷移(Web遷移の場合)-->
