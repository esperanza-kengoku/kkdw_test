...
/*表示開始日時*/
$startTime = new DateTime('2023-11-15 11:00:00');
/*表示終了日時*/
$closeTime = new DateTime('2023-12-01 11:59:59');
if ($now >= $startTime && $now < $closeTime): ?>
<a href="../page/page_231115_naruse_gacha.php">
<li class="newsContent-item">
    ...
    <!--遷移先URL-->
    <!--バナー表示-->
    <img src="<?php include '../../php/domain.php'; ?>/news/2023_1115_release/ban/231115_ban_NewCharacter_002.png" width="100%" alt="">
    <!--テキスト表示
    ※ガチャ画面に移動します<br>-->
    <!--メモ：URL遷移(Web遷移の場合)-->
