...
/*表示終了日時*/
$closeTime = new DateTime('2033-12-01 11:59:59');
...
<li class="newsContent-item">
    ...
    <!--遷移先URL-->
    <a href="../Character/page_231115_naruse.php">
    <!--バナー表示-->
    <img src="<?php include '../../php/domain.php'; ?>/news/2023_1115_release/ban/231115_ban_NewCharacter_001.png" width="100%" alt="">
    <!--テキスト表示
    ※ガチャ画面に移動します<br>-->
    </a>
    <!--メモ：URL遷移(Web遷移の場合)-->
