...
/*表示終了日時*/
$closeTime = new DateTime('2023-11-03 11:59:59');
...
<li class="newsContent-item">
    ...
    <!--遷移先URL-->
    <a href="../page/page_231101_pack001.php">
    <!--バナー表示-->
    <img src="<?php include '../../php/domain.php'; ?>/news/2023_1101_release/ban/ban_231101_pack001.png" width="100%" alt="">
    <!--テキスト表示
    ※ガチャ画面に移動します<br>-->
    </a>
    <!--メモ：URL遷移(Web遷移の場合)-->
