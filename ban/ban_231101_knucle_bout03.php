...
/*表示終了日時*/
$closeTime = new DateTime('2023-11-15 23:59:59');
if ($now >= $startTime && $now < $closeTime): ?>
<li class="newsContent-item">
    <div class="newsContent-itemBox">
        <!--種別-->
        <div class="newsTag tag_red">リーグ</div>
        <!--掲載日-->
        <div class="newsDate">2023.11.01</div>
    </div>
    <!--遷移先URL-->
    <a href="../page/page_231101_knuckle_bout03.php">
    <!--バナー表示-->
    <img src="<?php include '../../php/domain.php'; ?>/news/2023_1101_release/ban/league_banner_0001.png" width="100%" alt="">
    <!--テキスト表示
    ※ガチャ画面に移動します<br>-->
    </a>
    <!--メモ：URL遷移(Web遷移の場合)-->
