...
/*表示開始日時*/
$startTime = new DateTime('2023-11-05 12:00:00');
/*表示終了日時*/
...
<li class="newsContent-item">
    <div class="newsContent-itemBox">
        ...
        <!--掲載日-->
        <div class="newsDate">2023.11.05</div>
    </div>
    <!--遷移先URL-->
    <a href="../page/page_231105_ban_raid.php">
    <!--バナー表示-->
    <img src="<?php include '../../php/domain.php'; ?>/news/2023_1105_release/ban/231100_ban_raid_001.png" width="100%" alt="">
    <!--テキスト表示
    ※ガチャ画面に移動します<br>-->
    </a>
    <!--メモ：URL遷移(Web遷移の場合)-->
