...
<body>
  ...
  <div id="container">
    ...
    <?php
    $name_title = "販売期間";
    $ban_image ="/news/2023_1101_release/ban/231109_ban_pack001.png"; 
    $times ="11月09日12:00～11月12日12:00"; 
    ?>
              ...
              <div class="news-text box-dent">
                <div class="outline-2">
                      ...
                      <div class="border01 flexbox">
                        <div class="item-imgB">
                          <div class="space-reset" style="transform: scale(1)">
                            ...
                            <?//=========↓↓↓↓アイテム画像↓↓↓↓=========//?>
                            <img
                              src="<?php include '../../php/domain.php'; ?>/chara_Info_Sample/images/modules/00020.png">
                          </div>
                        </div>
                    ...
                    <div class="border01 flexbox">
                        ...
                        <div class="item-imgB">
                          <div class="space-reset" style="transform: scale(1)">
                            ...
                            <?//=========↓↓↓↓アイテム画像↓↓↓↓=========//?>
                            <img
                              src="<?php include '../../php/domain.php'; ?>/chara_Info_Sample/images/modules/05002.png">
                          </div>
                        </div>
                        <div class="item-infoB">
                          <div class="item-nameB">
                  ...
                  <div class="Att3">
                    <p class="Att4">【注意事項】</p>
                    <ol class="notes-1">
                      <li>5,000円・10,000円以外の金額全てでパックをご用意しております。</li>
