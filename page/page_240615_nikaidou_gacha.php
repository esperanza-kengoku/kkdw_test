              ...
              <div class="outline-2">
                ...
                <div id="image_padding">
                  <div align="center" class="shadow-drop">
                    <img src="<?php include '../../php/masterdomain.php'; ?>/images/Banner/240615_ban_NewCharacter_001.png" width="100%" alt="">
                  </div>
                </div>

                <div class="index-4" id="releasegacha">新キャラ「二階堂龍」登場‼</div>

                <div id="image_padding" class="mt-15">
                  <div align="center">
                    <img src="<?php include '../../php/masterdomain.php'; ?>/images/Banner/240615_page_NewCharacter_001.png"
                      alt="二階堂龍ガチャ" width="100%">
                  </div>
                </div>
                ...
                <div class="tabbox mt-20">
                  ...
                  <div class="tabsilver" id="tabsilver5">
                    ...
                    <p class="con-2">6/15 12:00 ~ 6/18 12:00</p>

                    <p class="index-2">３日間&有償極石限定!!<span class="red fs16">ステップ20で確定する限定ガチャ</span>が登場！</p>
                    <div class="mt-20">
                    <img src="<?php include '../../php/masterdomain.php'; ?>/images/Banner/240615_rush_NewCharacter_002.png"
                        alt="二階堂龍ガチャ" width="100%">
                    </div>
                    <div class="con-2">
                      <p><span class="fg-Gold fs16">二階堂龍や次回特攻装備の確率が超絶アップ!!<br>しかも5ステップ毎に二階堂龍の魂だけが排出される激アツモードに突入する特別仕様!!</span>
                        さらに確定枠で二階堂龍を確実に入手可能！ 期間限定の激アツガチャを見逃すな！</p>
                      </p>
                    </div>
                    <div class="frame-1 mt-20 mb-20">
                      ...
                      <p class="hr_grd2"></p>
                      <ol class="notes-2">
                        <li>ステップアップガチャとなっており、ステップ20で<span class="fg-Gold fs16">二階堂龍が確定</span>で入手できます。</li>
                        <li>ステップアップ毎に二階堂龍の排出確率が上がっていきます</li>
                  ...
                  <div class="tabsilver" id="tabsilver1">
                    ...
                    <div class="index-2">開催期間</div>
                    <p class="con-2">6/15 12:00 ~ 7/1 12:00</p>

                    <p class="index-2">期間限定で<span class="red fs16">二階堂龍PUガチャ</span>を開催！</p>
                    <div class="mt-20">
                    <img src="<?php include '../../php/masterdomain.php'; ?>/images/Banner/240615_setting_NewCharacter.png"
                        alt="二階堂龍ガチャ" width="100%">
                    </div>
                    <div class="con-2">
                      <p><span class="fg-Gold fs16">二階堂龍をピックアップ！</span>
                        期間限定の激アツガチャを見逃すな！</p>
                    </div>
                  ...
                  <div class="tabsilver" id="tabsilver2">
                    <div class="index-2 mb-20">伍龍ノ降臨</div>
                    <img src="<?php include '../../php/masterdomain.php'; ?>/images/Banner/240615_rush_NewCharacter_001.png"
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td valign="middle" style="vertical-align: middle;"><img
                              src="<?php include '../../php/masterdomain.php'; ?>/images/EquipmentIcon/eq_00076.png"
                              width="100%" alt=""></td>
                          <td valign="middle" style="vertical-align: middle;">00</td>
                        ...
                        <tr>
                          <td rowspan="2" valign="middle" style="vertical-align: middle; font-size: 0.7rem !important;">
                            高級懐中時計<br>【華神会】</td>
                          <td valign="middle" style="vertical-align: middle;"><img
                              src="<?php include '../../php/masterdomain.php'; ?>/images/EquipmentIcon/eq_00077.png"
                              width="100%" alt=""></td>
