...
/*表示終了日時*/
$closeTime = new DateTime('2024-08-01 11:59:59');
if ($now >= $startTime && $now < $closeTime): ?>
    <!--遷移先URL-->
    <a href="../page/page_info004.php">
  ...
  <li class="newsContent-item">
    <div class="newsContent-itemBox">
        ...
        <!--掲載日-->
        <div class="newsDate">2024.07.26</div>
    </div>
        <!--バナー表示-->
        <img src="<?php include '../../php/masterdomain.php'; ?>/images/Banner/240727_ban_info001.png" width="100%" alt="">
    </a>
    <!--メモ：URL遷移(Web遷移の場合)-->
