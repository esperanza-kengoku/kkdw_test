...
<body>
  ...
  <div id="container">
    ...
    <!--編集箇所-->
    <?php
    $name_title = "販売期間<br>11月23日0:00～11月23日23:59";
    $ban_image ="/news/2023_1124_release/ban/231123_ban_addition.png"; 
    $times =""; 
    ?>
              ...
              <div class="news-text box-dent">
                <div class="outline-2">
                  ...
                  <div class="tabbox mt-20">
                      ...
                      <div class="border01 flexbox">
                        <div class="item-imgB">
                          <div class="space-reset" style="transform: scale(1)">
                            ...
                            <?//=========↓↓↓↓アイテム画像↓↓↓↓=========//?>
                            <img
                              src="<?php include '../../php/domain.php'; ?>/chara_Info_Sample/images/modules/100163.png">
                          </div>
                        </div>
                      ...
                      <div class="border01 flexbox">
                        <div class="item-imgB">
                          <div class="space-reset" style="transform: scale(1)">
                            ...
                            <?//=========↓↓↓↓アイテム画像↓↓↓↓=========//?>
                            <img
                              src="<?php include '../../php/domain.php'; ?>/chara_Info_Sample/images/modules/00002.png">
                          </div>
                        </div>
                        <div class="item-infoB">
                          <div class="item-nameB">
                    ...
                    <label for="tabchecksilver4" class="tab1">10,000円</label>
                  ...
                  <div class="Att3">
                    <p class="Att4">【注意事項】</p>
                    <ol class="notes-1">
                      <li>通常パックの極石、VIPptの他に上記素材がついてくるパックとなります。</li>
                      <li>購入特典でついてくる極石は全て有償極石となります。各種キャンペーンにてお使い頂けます。</li>
                    </ol>
                  </div>
