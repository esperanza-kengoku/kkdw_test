...
<body>
  ...
  <div id="container">
    ...
    <!--編集箇所-->
    <?php
    $name_title = "販売期間<br>11月24日12:00～11月27日12:00";
    $ban_image ="/news/2023_1124_release/ban/231124_ban_pack001.png"; 
    $times =""; 
    ?>
              ...
              <div class="news-text box-dent">
                <div class="outline-2">
                  ...
                  <div class="tabbox mt-20">
                    ...
                    <label for="tabchecksilver1" class="tab1">1,200円(無制限)</label>
                      ...
                      <div class="border01 flexbox">
                        <div class="item-imgB">
                          <div class="space-reset" style="transform: scale(1)">
                            ...
                            <?//=========↓↓↓↓アイテム画像↓↓↓↓=========//?>
                            <img
                              src="<?php include '../../php/domain.php'; ?>/chara_Info_Sample/images/modules/03104.png">
                          </div>
                        </div>
                    ...
                    <label for="tabchecksilver4" class="tab1">15,000円(3回限り)</label>
                    ...
                    <label for="tabchecksilver2" class="tab1">10,000円(3回限り)</label>
                    ...
                    <label for="tabchecksilver3" class="tab1">20,000円(3回限り)</label>
                  ...
                  <div class="Att3">
                    <p class="Att4">【注意事項】</p>
                    <ol class="notes-1">
                      <li>極パスの使用期限は27日12時までとなります。ご注意ください。</li>
