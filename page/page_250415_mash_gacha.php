...
$top_image ="250415_page_NewCharacter.png";/*トップ画像*/ 
$top_image2 ="250415_page_meifan.png";/*登場画像*/ 
$icon_image ="00194.png"; /*アイコン*/
$eqicon_image01 ="eq_00132.png"; /*装備アイコン*/
$eqicon_image02 ="eq_00133.png"; /*装備アイコン*/
...
$Lskill_name ="グレイトウォール"; /*リーダースキル名*/
$Lskill_effect="味方全体の防御力を50％アップ"; /*リーダースキル内容*/

$skill_name ="カナディアンスクリューボマー"; /*スキル名*/
$skill_effect ="敵３体に5秒間40％で発動する麻痺を付与+悪属性300％ダメージ×5"; /*スキル内容*/
$skill_effectMAX ="敵３体に5秒間<span class=\"txtYellow fs-12\">80％で発動する麻痺</span>を付与+<span class=\"txtYellow fs-12\">悪属性600％ダメージ×5</span>"; /*スキル内容*/
  
$eq_skill_name ="ピボット"; /*スキル名*/
$eq_skill_effect ="戦闘開始時、自分自身の即死・封技耐性を<span class=\"txtYellow fs-12\">10秒間100％増加</span>+味方全体の即死耐性を<span class=\"txtYellow fs-12\">10秒間20％増加</span>"; /*スキル内容*/
              ...
              <div class="outline-2">
                ...
                <div id="image_padding">
                  <div align="center" class="shadow-drop">
                    <img src="<?php include '../../php/masterdomain.php'; ?>/images/Banner/250415_ban_NewCharacter_001.png" width="100%" alt="">
                  </div>
                </div>
                ...
                <div id="image_padding" class="mt-15">
                  <div align="center">
                    <img src="<?php include '../../php/masterdomain.php'; ?>/images/NewInfo/250415_page_NewCharacter.png"
                      alt="ガチャ" width="100%">
                  </div>
                </div>
                ...
                <div class="tabbox mt-20">
                  ...
                  <div class="tabsilver" id="tabsilver5">
                    ...
                    <p class="con-2">04/15 12:00~ 04/19 12:00</p>
                ...
                <p class="ta-c fs-12">▼ ガチャ性能比較 ▼</p>
                  <table id="Table01" class="mt-20 fs-12">
                    ...
                    <div class="frame-1 mt-20 mb-20 fs-12">
                      ...
                      <ol class="notes-2 fs-12">
                        <li><span class="txtYellow"><? echo $CharaName;?>・エアフィフス・キングジャケット</span>のいずれかが入手できます</li>
                        <li>ガチャ10回目でチャンスに突入します。チャンスに挑戦後は1回目からに戻ります。</li>
                    ...
                    <div class="frame-1 mt-20 mb-20 fs-12">
                      ...
                      <ol class="notes-2 fs-12">
                        ...
                        <li>50回目前後で<span class="txtYellow">セレスティアかマッシュどちらかが確定する</span>限定モードが発動します</li>
                    ...
                    <div class="frame-1 mt-20 mb-20 fs-12">
                      ...
                      <p class="hr_grd2"></p>
                      <ol class="notes-2 fs-12">
                        <li>通常のキャラガチャにマッシュが追加されております</li>
                      </ol>
                    </div>
                  ...
                  <label for="tabchecksilver2" class="tab1">マッシュ詳細</label>
            ...
            <img src="<?php include '../../php/masterdomain.php'; ?>/images/Banner/<?php echo $top_image2 ?>" alt="">
                   ...
                   <p class="ta-c fs-14">▼ 総合力比較 ▼</p>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td valign="middle" style="vertical-align: middle;"><img src="<?php include '../../php/masterdomain.php'; ?>/images/CharaIcon/ic_<?php echo $icon_image ?>" width="100%" alt="マッシュ"><br>マッシュ<br>(限突+30/覚醒+30)</td>
                        <td valign="middle" style="vertical-align: middle;">11,670</td>
                        <td valign="middle" style="vertical-align: middle;">1,715</td>
                        <td valign="middle" style="vertical-align: middle;">815</td>
                        <td valign="middle" style="vertical-align: middle;">351</td>
                      </tr>
                      <tr>
                        <td colspan="5" valign="middle" style="vertical-align: middle; font-size: 1.2rem !important;">
                      総合力：<span class="txtYellow">14,551</span>(バトル時のみ)<br></td>
                      </tr>
                      <tr>
                        <td valign="middle" style="vertical-align: middle;"><img src="<?php include '../../php/masterdomain.php'; ?>/images/CharaIcon/ic_00155.png" width="100%" alt="御堂"><br>セレスティア<br>(限突+40/覚醒+40)</td>
                  ...
                  ※マッシュには「エアパワー」と「ステータスアップキャンペーン」をそれぞれ装備した想定で算出しております。<br>強化値が+30にて、セレスティアのカンスト状態と同等の強さを発揮できます。<br>※実際の総合力と誤差がある場合がございます。目安として参照ください。
