          ...
          <div id="mainContent">
            <div id="news" class="newsDetail">
              ...
              <div class="news-text box-dent">
                ...
                <div id="image_padding">
                    <div align="center">
                      <img src="<?php include '../../php/masterdomain.php'; ?>/images/Banner/241120_page_event_Sanken_no_Kiwami_001.png"
                        alt="BDCPバナー" width="100%" class="header_img">
                    </div>
                  </div> 
              ...
              <?//=========タブ毎にid="tabchecksilver1"、for="tabchecksilver1"、id="tabsilver1"の数字を揃える=========//?>
                <label for="tabchecksilver1" class="tab1">対戦勝利</label>
                  ...
                  <div class="btn01 mt-20 mb-20">
                    ...
                    <label for="tabchecksilver2" class="tab1">襲来</label>

                    <div class="tabsilver" id="tabsilver2">
                    <div class="index-2">ランキング</div>
                        <p class="con-2 fs-12">襲来VS桜庭の100レベルを撃破した数</p>

                       <div class="index-2 fs-12">目玉報酬 <br><span class="txtYellow">レオの魂×1,000!!</span></div>
                  ...
                  <div class="btn01 mt-20 mb-20">
                    ...
                    <div class="index-2">ランキング</div>
                        ...
                        <div class="index-2 fs-12">目玉報酬 <br><span class="txtYellow">★４装備スキルマスター【攻ノ書】</span></div>
                                        ...
                                        <div class="second-info__inner inner">
                                            <div class="param-info_icon">
                                                <div class="param-info_icon_chara">
                                                    ...
                                                    <img src="<?php include '../../php/masterdomain.php'; ?>/images/EquipmentIcon/eq_00101.png" alt=""><br><p>スキルマスター【攻ノ書】</p>
...
<?
$eq_skill_effect ="装備キャラの状態異常を3つ解除<br><span class=\"txtYellow fs-12\">15秒間30％</span>の鋭化<br>自身の<span class=\"txtYellow fs-12\">スキルゲージを30％</span>アップ<br>必要スキルゲージ量を<span class=\"txtYellow fs-12\">15秒間1％減少</span>"; /*スキル内容*/
?>
...
<p class="con-2 fs-12 mt-10">
                    三拳ノ極ランキング限定の★４装備!!<br>
                    <span class="txtYellow">誰でも装備できる初の★4装備!!</span><br>
                    <span class="txtYellow">スキル変動系の厄介なスキルに徹底対抗できる!!</span><br>
                    スキルマスター【攻ノ書】が登場!!<br><br>
                    <span class="txtGreen">【魅力.1】</span>【鈍化】を無力化!! 開始時の状態異常解除で鈍化を消し去る!!<br><br>
                  	<span class="txtGreen">【魅力.2】</span>【必要スキルゲージ量増加】を無力化!! 開始時の状態異常解除で必要スキルゲージ量増加を消し去る!!<br><br>
                    <span class="txtGreen">【魅力.3】</span>その上で<span class="txtYellow">鋭化+スキルゲージアップ</span>!! スキルをガンガン放てるようになるぞ!!<br><br>
                ...
                <?//=========タブ3END=========//?>
                  ...
                  <?//=========tabbox タブ終わり=========//?>
                    ...
                    <ol class="notes-1 fs-12">
                      ...
                      <li>イベント限定報酬として、全キャラが装備可能な<span class="txtYellow">★４装備スキルマスター【攻ノ書】</span>が入手できます</li>
